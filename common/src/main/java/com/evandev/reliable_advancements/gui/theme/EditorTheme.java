...
public final class EditorTheme {
    ...
    public static final ResourceLocation ICON_CHEVRON_DOWN = ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "textures/gui/icons/chevron_down.png");
    public static final ResourceLocation ICON_CHEVRON_DOWN_HOVER = ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "textures/gui/icons/chevron_down_hover.png");
    public static final ResourceLocation ICON_CHEVRON_DOWN_GOLD = ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "textures/gui/icons/chevron_down_gold.png");
    public static final ResourceLocation ICON_CHEVRON_RIGHT = ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "textures/gui/icons/chevron_right.png");
    public static final ResourceLocation ICON_CHEVRON_RIGHT_HOVER = ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "textures/gui/icons/chevron_right_hover.png");
    public static final ResourceLocation ICON_CHEVRON_RIGHT_GOLD = ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "textures/gui/icons/chevron_right_gold.png");

    private EditorTheme() {
    }

    public static void drawWindow(GuiGraphics gfx, int x, int y, int w, int h) {
        gfx.fill(x - 1, y - 1, x + w + 1, y + h + 1, BORDER_OUTER);
        gfx.fill(x, y, x + w, y + h, PANEL_BG);
        gfx.renderOutline(x, y, w, h, BORDER_INNER);
        gfx.fill(x + 1, y + 1, x + w - 1, y + 2, ACCENT_GOLD_MUTED);
    }

    public static void drawCard(GuiGraphics gfx, int x, int y, int w, int h) {
        gfx.fill(x, y, x + w, y + h, CARD_BG);
        gfx.renderOutline(x, y, w, h, CARD_BORDER);
    }

    public static void drawBadge(GuiGraphics gfx, Font font, String text, int x, int y, int bgCol, int textCol) {
        int width = font.width(text) + 8;
        int height = 12;
        gfx.fill(x, y, x + width, y + height, bgCol);
        gfx.renderOutline(x, y, width, height, (bgCol & 0x00FFFFFF) | 0x88000000);
        gfx.drawString(font, text, x + 4, y + 2, textCol, false);
    }

    public static void drawSectionHeader(GuiGraphics gfx, Font font, String title, int x, int y, int width) {
        gfx.drawString(font, title, x, y, TEXT_GOLD, false);
    ...
    public static void drawChevronIcon(GuiGraphics gfx, int x, int y, boolean expanded, boolean hovered) {
