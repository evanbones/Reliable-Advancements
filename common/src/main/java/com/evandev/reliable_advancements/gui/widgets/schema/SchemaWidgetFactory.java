...
public final class SchemaWidgetFactory {
    ...
    private static void drawTreeGuideline(GuiGraphicsExtractor gfx, int x, int y, int height, int depth) {
    ...
    public static class TreeChevronWidget extends AbstractWidget {
        ...
        protected void extractWidgetRenderState(@NotNull GuiGraphicsExtractor gfx, int mouseX, int mouseY, float partialTick) {
            ...
            if (hovered) {
                ...
                gfx.outline(getX(), getY(), width, height, EditorTheme.CARD_BORDER);
            }
            ...
            return new EditorForm.FormRow() {
                ...
                public void render(GuiGraphicsExtractor gfx, Font font, int mouseX, int mouseY, float partialTicks) {
                    ...
                    if (label != null && !label.isEmpty()) {
                        ...
                        gfx.text(font, label, indentX, y + 5, labelCol, false);
                    }
                    chevron.extractRenderState(gfx, mouseX, mouseY, partialTicks);
            ...
            return new EditorForm.FormRow() {
                ...
                public void render(GuiGraphicsExtractor gfx, Font font, int mouseX, int mouseY, float partialTicks) {
                    if (!isInline) {
                        ...
                        int labelCol = !isUnset() ? EditorTheme.TEXT_GOLD : EditorTheme.TEXT_LABEL;
                        gfx.text(font, label, indentX + 4, y + 5, labelCol, false);
                    }
                    button.extractRenderState(gfx, mouseX, mouseY, partialTicks);
                }
        ...
        public EditorForm.FormRow createFormRow(String label, Font font, Runnable onFormChanged) {
            ...
            return new EditorForm.FormRow() {
                ...
                public void render(GuiGraphicsExtractor gfx, Font font, int mouseX, int mouseY, float partialTicks) {
                    ...
                    box.extractRenderState(gfx, mouseX, mouseY, partialTicks);
                }
            ...
            return new EditorForm.FormRow() {
                ...
                public void render(GuiGraphicsExtractor gfx, Font font, int mouseX, int mouseY, float partialTicks) {
                    ...
                    if (hasPreview) {
                        ...
                        if (!stack.isEmpty()) {
                            gfx.fakeItem(stack, prevX, prevY + 1);
                        }
                    }
                }
        ...
        public EditorForm.FormRow createFormRow(String label, Font font, Runnable onFormChanged) {
            ...
            return new EditorForm.FormRow() {
                ...
                public void render(GuiGraphicsExtractor gfx, Font font, int mouseX, int mouseY, float partialTicks) {
                    ...
                    dropdown.extractRenderState(gfx, mouseX, mouseY, partialTicks);
                }
            ...
            return new EditorForm.FormRow() {
                ...
                public void render(GuiGraphicsExtractor gfx, Font font, int mouseX, int mouseY, float partialTicks) {
                    ...
                    if (!isHeaderless) {
                        ...
                        chevron.extractRenderState(gfx, mouseX, mouseY, partialTicks);
                        int labelCol = !isUnset() ? EditorTheme.TEXT_GOLD : EditorTheme.TEXT_LABEL;
                        gfx.text(font, label, indentX + 18, y + 5, labelCol, false);
                    }
        ...
        public EditorForm.FormRow createFormRow(String label, Font font, Runnable onFormChanged) {
            return new EditorForm.FormRow() {
                ...
                public void render(GuiGraphicsExtractor gfx, Font font, int mouseX, int mouseY, float partialTicks) {
                    ...
                    int labelCol = !isUnset() ? EditorTheme.TEXT_GOLD : EditorTheme.TEXT_LABEL;
                    gfx.text(font, header, indentX + 18, y + 5, labelCol, false);
                    ...
                    if (chevron.isExpanded()) {
                        for (ListItem item : items) {
                            ...
                            item.removeBtn.extractRenderState(gfx, mouseX, mouseY, partialTicks);
                        }
                    }
                }
        ...
        public EditorForm.FormRow createFormRow(String label, Font font, Runnable onFormChanged) {
            return new EditorForm.FormRow() {
                ...
                public void render(GuiGraphicsExtractor gfx, Font font, int mouseX, int mouseY, float partialTicks) {
                    ...
                    if (chevron.isExpanded()) {
                        for (MapEntryItem item : entries) {
                            item.keyBox.extractRenderState(gfx, mouseX, mouseY, partialTicks);
